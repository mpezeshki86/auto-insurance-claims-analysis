...
This project uses the freMTPL2 French Motor Third-Party Liability motor insurance dataset. The frequency dataset contains 678,013 policy records and includes claim counts, policy exposure, driver characteristics, vehicle characteristics, BonusMalus, and geographic information.
